package com.xir.TimeVial.client;

import static com.xir.TimeVial.config.Config.enableNumberMultiplierTexture;
...
public class RenderTimeAccelerator extends Render {
    ...
    static {
        final String pathURL = "timevial:textures/entity/";
